<?php
    ...
    $inmi_knowledge_articles = [
        [
            'url' => '/bakterii-dlya-septika-zapusk-vosstanovlenie/',
        ...
        [
            'url' => '/golubika-posle-posadki-adaptaciya-sazhencev/',
        ...
        [
            'url' => '/inokulyaciya-soi-obrabotka-semyan/',
        ...
        [
            'url' => '/kak-sohranit-pitatelnost-silosa-bakterialnye-zakvaski/',
        ...
        [
            'url' => '/obrabotka-semyan-ozimoy-pshenicy-biopreparatami/',
        ...
        [
            'url' => '/zhiry-v-stochnyh-vodah-zhiroulovitel/',
